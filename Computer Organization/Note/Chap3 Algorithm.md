...
![[Pasted image 20241023190204.png]]

##### E.g.1 计算 7-6=1
![[Pasted image 20241023190419.png]]

> [!NOTE] 二进制相反数
> 如图，对6取相反数-6的步骤是：直接把所有位（包括符号位）都取反，然后给最低位+1

##### E.g.2 计算41-26=15
![[Pasted image 20241025212752.png]]
...
#### 1. 【纸笔运算】
---
![[Pasted image 20241023192147.png]]
...
**E.g.**
![[Pasted image 20241023194028.png]]

#### 2. 【乘法器硬件】
---
![[Pasted image 20241023192850.png]]
...
![[Pasted image 20241023193650.png]]
`这个改进版的乘法器的运行机制是什么？`
...
## 浮点乘法
##### E.g.
![[Pasted image 20241018215716.png]]
...
**【第二步】有效数位部分的相乘
![[Pasted image 20241018220330.png]]
...
**【第三步】规格化、检测上/下溢**
![[Pasted image 20241018220602.png]]
...
**E.g.**
![[Pasted image 20241018145713.png]]
